...
namespace Microsoft.Azure.Cosmos.Spatial
{
    ...
    /// </summary>
    [DataContract]
    [System.Text.Json.Serialization.JsonConverter(typeof(TextJsonBoundingBoxConverter))]
    [Newtonsoft.Json.JsonConverter(typeof(BoundingBoxJsonConverter))]
    public sealed class BoundingBox : IEquatable<BoundingBox>
    {
        ...
        /// </value>
        [DataMember(Name = "min")]
        public Position Min { get; internal set; }
        ...
        /// </value>
        [DataMember(Name = "max")]
        public Position Max { get; internal set; }
