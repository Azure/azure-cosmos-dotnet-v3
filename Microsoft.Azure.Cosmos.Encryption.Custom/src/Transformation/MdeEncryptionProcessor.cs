...
namespace Microsoft.Azure.Cosmos.Encryption.Custom.Transformation
{
    ...
    internal class MdeEncryptionProcessor
    {
            ...
            CancellationToken token)
        {
            ...
            using IDisposable selectionScope = diagnosticsContext?.CreateScope("EncryptionProcessor.Encrypt.Mde." + jsonProcessor);
            ...
            CancellationToken cancellationToken)
        {
            ...
            using CosmosDiagnosticsContext.Scope? selectionScope = diagnosticsContext?.CreateScope("EncryptionProcessor.Decrypt.Mde." + jsonProcessor);
            ...
            CancellationToken cancellationToken)
        {
            ...
            JsonProcessor jsonProcessor = this.GetRequestedJsonProcessor(requestOptions);
#if NET8_0_OR_GREATER
            using IDisposable selectionScope = diagnosticsContext?.CreateScope("EncryptionProcessor.Decrypt.Mde." + jsonProcessor);
#endif
            ...
            CancellationToken cancellationToken)
        {
            ...
            {
                using IDisposable selectionScope = diagnosticsContext?.CreateScope("EncryptionProcessor.Encrypt.Mde." + JsonProcessor.Stream);
