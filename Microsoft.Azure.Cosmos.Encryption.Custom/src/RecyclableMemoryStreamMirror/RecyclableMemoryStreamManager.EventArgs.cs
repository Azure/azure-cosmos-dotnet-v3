...
namespace Microsoft.Azure.Cosmos.Encryption.Custom.RecyclableMemoryStreamMirror
{
    ...
    public sealed partial class RecyclableMemoryStreamManager
    {
        ...
        {
            /// <summary>
            /// Gets unique ID for the stream.
            /// </summary>
            public Guid Id { get; }

            /// <summary>
            /// Gets optional Tag for the event.
            /// </summary>
            public string Tag { get; }

            /// <summary>
            /// Gets requested stream size.
            /// </summary>
            public long RequestedSize { get; }

            /// <summary>
            /// Gets actual stream size.
            /// </summary>
        ...
        public sealed class StreamDisposedEventArgs : EventArgs
        {
            ...
            /// <summary>
            /// Gets stack where the stream was allocated.
            /// </summary>
            public string AllocationStack { get; }

            /// <summary>
            /// Gets stack where stream was disposed.
            /// </summary>
            public string DisposeStack { get; }

            /// <summary>
            /// Gets lifetime of the stream.
            /// </summary>
        ...
        public sealed class StreamDoubleDisposedEventArgs : EventArgs
        {
            ...
            /// <summary>
            /// Gets first dispose stack.
            /// </summary>
            public string DisposeStack1 { get; }

            /// <summary>
            /// Gets second dispose stack.
            /// </summary>
        ...
        public sealed class StreamConvertedToArrayEventArgs : EventArgs
        {
            ...
            /// <summary>
            /// Gets stack where ToArray was called.
            /// </summary>
        ...
        public sealed class StreamOverCapacityEventArgs : EventArgs
        {
            ...
            /// <summary>
            /// Gets original allocation stack.
            /// </summary>
            public string AllocationStack { get; }

            /// <summary>
            /// Gets requested capacity.
            /// </summary>
        ...
        {
            /// <summary>
            /// Gets how many bytes are currently in use from the small pool.
            /// </summary>
        ...
        public sealed class LargeBufferCreatedEventArgs : EventArgs
        {
            ...
            /// <summary>
            /// Gets a value indicating whether whether the buffer was satisfied from the pool or not.
            /// </summary>
            public bool Pooled { get; }

            /// <summary>
            /// Gets required buffer size.
            /// </summary>
            public long RequiredSize { get; }

            /// <summary>
            /// Gets how many bytes are in use from the large pool.
            /// </summary>
            public long LargePoolInUse { get; }

            /// <summary>
            /// Gets if the buffer was not satisfied from the pool, and <see cref="Options.GenerateCallStacks"/> is turned on, then.
        ...
        public sealed class BufferDiscardedEventArgs : EventArgs
        {
            ...
            /// <summary>
            /// Gets type of the buffer.
            /// </summary>
            public Events.MemoryStreamBufferType BufferType { get; }

            /// <summary>
            /// Gets the reason this buffer was discarded.
            /// </summary>
        ...
        {
            /// <summary>
            /// Gets bytes from the small pool currently in use.
            /// </summary>
            public long SmallPoolInUseBytes { get; }

            /// <summary>
            /// Gets bytes from the small pool currently available.
            /// </summary>
            public long SmallPoolFreeBytes { get; }

            /// <summary>
            /// Gets bytes from the large pool currently in use.
            /// </summary>
            public long LargePoolInUseBytes { get; }

            /// <summary>
            /// Gets bytes from the large pool currently available.
            /// </summary>
