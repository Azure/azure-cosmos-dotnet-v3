    ...
    public partial class EncryptionBenchmark
    {
        ...
        public async Task Setup()
        {
            ...
            keyProvider
                ...
                .Returns(async () => await MdeEncryptionAlgorithm.CreateAsync(DekProperties, Data.Encryption.Cryptography.EncryptionType.Randomized, KeyStoreProvider, cacheTimeToLive: TimeSpan.MaxValue, withRawKey: false, cancellationToken: default));
