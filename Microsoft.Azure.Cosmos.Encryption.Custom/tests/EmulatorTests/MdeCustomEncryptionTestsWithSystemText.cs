...
cancellationToken) =>
        ...
        private class TestEncryptionKeyStoreProvider : EncryptionKeyStoreProvider
        {
            ...
            {
                this.UnWrapKeyCallsCount[masterKeyPath] = !this.UnWrapKeyCallsCount.TryGetValue(masterKeyPath, out int value) ? 1 : ++value;
            ...
            {
                this.WrapKeyCallsCount[masterKeyPath] = !this.WrapKeyCallsCount.TryGetValue(masterKeyPath, out int value) ? 1 : ++value;
...
#pragma warning disable CS0618 // Type or member is obsolete
        ...
        private class TestKeyWrapProvider : EncryptionKeyWrapProvider
        {
            ...
            {
                this.WrapKeyCallsCount[metadata.Value] = !this.WrapKeyCallsCount.TryGetValue(metadata.Value, out int value) ? 1 : ++value;
