...
#pragma warning restore CS0618
        ...
        public async Task EncryptDecrypt_StreamProcessor_WithProvidedOutput()
        {
            ...
            Assert.AreEqual(1, diagEncrypt.Scopes.Count(s => s.StartsWith("EncryptionProcessor.Encrypt.Mde." + JsonProcessor.Stream)), "Expected a single Stream selection scope for encrypt");
            Assert.IsFalse(diagEncrypt.Scopes.Any(s => s.StartsWith("EncryptionProcessor.Encrypt.Mde." + JsonProcessor.Newtonsoft)));
            ...
            Assert.AreEqual(1, diagDecrypt.Scopes.Count(s => s.StartsWith("EncryptionProcessor.Decrypt.Mde." + JsonProcessor.Stream)), "Expected a single Stream selection scope for decrypt");
            Assert.IsFalse(diagDecrypt.Scopes.Any(s => s.StartsWith("EncryptionProcessor.Decrypt.Mde." + JsonProcessor.Newtonsoft)));
        }
    ...
    Assert.AreEqual(1, diagEncrypt.Scopes.Count(s => s.StartsWith("EncryptionProcessor.Encrypt.Mde." + JsonProcessor.Newtonsoft)), "Expected a single Newtonsoft selection scope for encrypt");
    Assert.IsFalse(diagEncrypt.Scopes.Any(s => s.StartsWith("EncryptionProcessor.Encrypt.Mde." + JsonProcessor.Stream)));
        ...
        public async Task Decrypt_StreamSelection_FallbackWhenUnencrypted()
        {
            ...
            Assert.AreEqual(1, ctxDiag.Scopes.Count(s => s.StartsWith("EncryptionProcessor.Decrypt.Mde." + JsonProcessor.Stream)), "Expected a single Stream selection scope when falling back for unencrypted payload");
            Assert.IsFalse(ctxDiag.Scopes.Any(s => s.StartsWith("EncryptionProcessor.Decrypt.Mde." + JsonProcessor.Newtonsoft)));
        }
#endif
