...
namespace Microsoft.Azure.Cosmos.Encryption.Tests
{
    ...
    public class MdeEncryptionProcessorTests
    {
        ...
        public static void ClassInitialize(TestContext testContext)
        {
            ...
            MdeEncryptionProcessorTests.mockEncryptor.Setup(m => m.GetEncryptBytesCount(It.IsAny<int>(), It.IsAny<string>(), It.IsAny<string>(), It.IsAny<CancellationToken>()))
            ...
            MdeEncryptionProcessorTests.mockEncryptor.Setup(m => m.EncryptAsync(It.IsAny<byte[]>(), It.IsAny<int>(), It.IsAny<int>(), It.IsAny<byte[]>(), It.IsAny<int>(), It.IsAny<string>(), It.IsAny<string>(), It.IsAny<CancellationToken>()))
                .ReturnsAsync((byte[] plainText, int plainTextOffset, int _, byte[] output, int outputOffset, string dekId, string algo, CancellationToken t) =>
                        dekId == MdeEncryptionProcessorTests.dekId ? TestCommon.EncryptData(plainText, plainTextOffset, output, outputOffset) : throw new InvalidOperationException("DEK not found."));
            ...
            MdeEncryptionProcessorTests.mockEncryptor.Setup(m => m.GetDecryptBytesCount(It.IsAny<int>(), It.IsAny<string>(), It.IsAny<string>(), It.IsAny<CancellationToken>()))
            ...
            MdeEncryptionProcessorTests.mockEncryptor.Setup(m => m.DecryptAsync(It.IsAny<byte[]>(), It.IsAny<int>(), It.IsAny<int>(), It.IsAny<byte[]>(), It.IsAny<int>(), It.IsAny<string>(), It.IsAny<string>(), It.IsAny<CancellationToken>()))
                .ReturnsAsync((byte[] cipherText, int cipherTextOffset, int _, byte[] output, int outputOffset, string dekId, string algo, CancellationToken t) =>
                        dekId == MdeEncryptionProcessorTests.dekId ? TestCommon.DecryptData(cipherText, cipherTextOffset, output, outputOffset) : throw new InvalidOperationException("DEK not found."));
        }
