...
namespace Microsoft.Azure.Cosmos.Encryption.Tests
{
    ...
    ///
    /// What it does NOT protect against: it cannot retroactively prove that the released
    /// preview07 MDE ciphertext decrypts (that pipeline cannot run inside this repo). It
