...
namespace Microsoft.Azure.Cosmos.Encryption.Tests
{
    ...
    internal static class TestEncryptorFactory
    {
        public static Mock<Encryptor> CreateMde(string dekId, out Mock<DataEncryptionKey> dekMock)
        {
            ...
            Mock<IDataEncryptionKeyBuffer> bufferDek = localDek.As<IDataEncryptionKeyBuffer>();
            bufferDek.Setup(d => d.GetEncryptByteCount(It.IsAny<int>())).Returns<int>(i => i);
            bufferDek.Setup(d => d.GetDecryptByteCount(It.IsAny<int>())).Returns<int>(i => i);
            bufferDek.Setup(d => d.EncryptData(It.IsAny<byte[]>(), It.IsAny<int>(), It.IsAny<int>(), It.IsAny<byte[]>(), It.IsAny<int>()))
            ...
            bufferDek.Setup(d => d.DecryptData(It.IsAny<byte[]>(), It.IsAny<int>(), It.IsAny<int>(), It.IsAny<byte[]>(), It.IsAny<int>()))
            ...
            encryptor.As<IDataEncryptionKeyAccessor>()
