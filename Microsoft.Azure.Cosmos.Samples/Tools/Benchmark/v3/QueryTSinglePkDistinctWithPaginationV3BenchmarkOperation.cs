...
namespace CosmosBenchmark
{
    ...
    internal class QueryTSinglePkDistinctWithPaginationV3BenchmarkOperation : QueryTV3BenchmarkOperation
    {
        public QueryTSinglePkDistinctWithPaginationV3BenchmarkOperation(
