...
namespace CosmosBenchmark
{
    ...
    internal class QueryStreamCrossPkGroupByWithPaginationV3BenchmarkOperation : QueryTV3BenchmarkOperation
    {
        public QueryStreamCrossPkGroupByWithPaginationV3BenchmarkOperation (
