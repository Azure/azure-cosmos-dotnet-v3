...
namespace CosmosBenchmark
{
    ...
    internal class QueryStreamCrossPkGroupByFullDrainV3BenchmarkOperation : QueryTV3BenchmarkOperation
    {
        public QueryStreamCrossPkGroupByFullDrainV3BenchmarkOperation(
