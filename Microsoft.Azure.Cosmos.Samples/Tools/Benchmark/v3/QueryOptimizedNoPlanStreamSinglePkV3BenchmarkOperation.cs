...
namespace CosmosBenchmark
{
    ...
    internal class QueryOptimizedNoPlanStreamSinglePkV3BenchmarkOperation : IBenchmarkOperation
    {
        ...
        public QueryOptimizedNoPlanStreamSinglePkV3BenchmarkOperation(
