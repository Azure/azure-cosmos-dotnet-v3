...
namespace CosmosBenchmark
{
    ...
    internal class QueryStreamCrossPkDistinctWithPaginationV3BenchmarkOperation : QueryTV3BenchmarkOperation
    {
        public QueryStreamCrossPkDistinctWithPaginationV3BenchmarkOperation(
