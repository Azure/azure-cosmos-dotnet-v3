...
namespace CosmosBenchmark
{
    ...
    internal class QueryStreamSinglePkGroupByFullDrainV3BenchmarkOperation : QueryTV3BenchmarkOperation
    {
        public QueryStreamSinglePkGroupByFullDrainV3BenchmarkOperation(
