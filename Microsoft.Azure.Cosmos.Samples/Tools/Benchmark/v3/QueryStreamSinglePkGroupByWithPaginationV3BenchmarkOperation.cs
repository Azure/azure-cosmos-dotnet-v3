...
namespace CosmosBenchmark
{
    ...
    internal class QueryStreamSinglePkGroupByWithPaginationV3BenchmarkOperation : QueryTV3BenchmarkOperation
    {
        public QueryStreamSinglePkGroupByWithPaginationV3BenchmarkOperation(
