...
namespace Microsoft.Azure.Documents
{
    ...
    internal static class RntbdConstants
    {
        ...
        public sealed class Request : RntbdTokenStream<RequestIdentifiers>
        {
            ...
            public RntbdToken populateIndexMetricsText;
            ...
            public Request()
            {
                ...
                this.populateIndexMetricsText = new RntbdToken(false, RntbdTokenTypes.Byte, (ushort)RequestIdentifiers.PopulateIndexMetricsText);
        ...
        {
            public override int RequiredTokenCount => 1;
            ...
            public RntbdToken xPConfigurationSessionsCount;
            ...
            public RntbdToken reindexerProgress;
            public RntbdToken offerReplacePendingForMerge;
            public RntbdToken maxContentLength;
            public RntbdToken oldestActiveSchemaId;
            public RntbdToken physicalPartitionId;
            ...
            public Response()
            {
                ...
                this.xPConfigurationSessionsCount = new RntbdToken(false, RntbdTokenTypes.ULong, (ushort)ResponseIdentifiers.XPConfigurationSessionsCount);
                ...
                this.unflushedMergeLogEntryCount = new RntbdToken(false, RntbdTokenTypes.LongLong, (ushort)ResponseIdentifiers.UnflushedMergeLogEntryCount);
                ...
                this.reindexerProgress = new RntbdToken(false, RntbdTokenTypes.String, (ushort)ResponseIdentifiers.ReindexerProgress);
                this.offerReplacePendingForMerge = new RntbdToken(false, RntbdTokenTypes.Byte, (ushort)ResponseIdentifiers.OfferReplacePendingForMerge);
                this.maxContentLength = new RntbdToken(false, RntbdTokenTypes.ULong, (ushort)ResponseIdentifiers.MaxContentLength);
                this.oldestActiveSchemaId = new RntbdToken(false, RntbdTokenTypes.Long, (ushort)ResponseIdentifiers.OldestActiveSchemaId);
                this.physicalPartitionId = new RntbdToken(false, RntbdTokenTypes.String, (ushort)ResponseIdentifiers.PhysicalPartitionId);
                ...
                this.tokens = new RntbdToken[]
                {
                    ...
                    this.xPConfigurationSessionsCount,
                    ...
                    this.changeFeedInfo,
                    this.reindexerProgress,
                    this.offerReplacePendingForMerge,
                    this.maxContentLength,
                    this.oldestActiveSchemaId,
