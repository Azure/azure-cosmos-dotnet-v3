...
| `452` | Transaction aborted; successful ops rewritten to a rolled-back status | `false` |
| `408 Request Timeout` | Transaction still in progress | `true` |
| `449` | Coordinator race / retry-with | `true` |
