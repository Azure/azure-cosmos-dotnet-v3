...
dotnet test '.\Microsoft.Azure.Cosmos\tests\Microsoft.Azure.Cosmos.Tests\Microsoft.Azure.Cosmos.Tests.csproj' /p:NoWarn=NU1903 --filter "TestCategory=UpdateContract" --configuration Release
...
dotnet test '.\Microsoft.Azure.Cosmos\tests\Microsoft.Azure.Cosmos.EmulatorTests\Microsoft.Azure.Cosmos.EmulatorTests.csproj' /p:NoWarn=NU1903 --filter "TestCategory=UpdateContract" --configuration Release
...
dotnet test '.\Microsoft.Azure.Cosmos\tests\Microsoft.Azure.Cosmos.Tests\Microsoft.Azure.Cosmos.Tests.csproj' /p:NoWarn=NU1903 --filter "TestCategory=UpdateContract" --configuration Release -p:IsPreview=true
...
dotnet test '.\Microsoft.Azure.Cosmos.Encryption\tests\Microsoft.Azure.Cosmos.Encryption.Tests\Microsoft.Azure.Cosmos.Encryption.Tests.csproj' /p:NoWarn=NU1903 --filter "TestCategory=UpdateContract" --configuration Release
...
dotnet test '.\Microsoft.Azure.Cosmos.Encryption.Custom\tests\Microsoft.Azure.Cosmos.Encryption.Custom.Tests\Microsoft.Azure.Cosmos.Encryption.Custom.Tests.csproj' /p:NoWarn=NU1903 --filter "TestCategory=UpdateContract" --configuration Release
