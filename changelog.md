...
- [#1331](https://github.com/Azure/azure-cosmos-dotnet-v3/pull/1331) Add client encryption / decryption for transactional batch requests
- [#1352](https://github.com/Azure/azure-cosmos-dotnet-v3/pull/1352) Add capability to delete raw DEK from memory after expiry time
