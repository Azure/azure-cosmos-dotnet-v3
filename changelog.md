...
- [5966](https://github.com/Azure/azure-cosmos-dotnet-v3/issues/5966) Semantic Reranking (preview): Adds correctly spelled `SemanticRerankResult.TokenUsage` and marks the misspelled `TokenUseage` property as obsolete for compatibility.
