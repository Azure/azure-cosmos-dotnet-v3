...
- [5013](https://github.com/Azure/azure-cosmos-dotnet-v3/pull/5013) Direct Package: Adds upgrade to 3.37.10
> This contains a direct package fix for fixing an AggressiveTimeoutDetection connection bug
