...
- [5958](https://github.com/Azure/azure-cosmos-dotnet-v3/pull/5958) DistributedTransaction (preview): Fixes silent skip of malformed session tokens on DTX commit responses. Malformed tokens now throw `CosmosException` instead of being silently skipped.
