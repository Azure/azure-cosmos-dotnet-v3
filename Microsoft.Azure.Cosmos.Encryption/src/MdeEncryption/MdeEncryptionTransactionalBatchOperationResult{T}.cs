...
{
    internal sealed class MdeEncryptionTransactionalBatchOperationResult<T> : TransactionalBatchOperationResult<T>
    {
        /// <summary>
        ...
        internal MdeEncryptionTransactionalBatchOperationResult(T resource)
        {
