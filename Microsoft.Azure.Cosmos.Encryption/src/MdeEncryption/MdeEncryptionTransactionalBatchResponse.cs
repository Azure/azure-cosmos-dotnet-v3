...
namespace Microsoft.Azure.Cosmos.Encryption
{
    ...
    internal sealed class MdeEncryptionTransactionalBatchResponse : TransactionalBatchResponse
    {
        ...
        public MdeEncryptionTransactionalBatchResponse(
        ...
        public override TransactionalBatchOperationResult<T> GetOperationResultAtIndex<T>(int index)
        {
            ...
            return new MdeEncryptionTransactionalBatchOperationResult<T>(resource);
        }
