...
namespace Microsoft.Azure.Cosmos.SDK.EmulatorTests
{
    ...
    internal static class TestCommon
    {
        ...
        public static async Task DeleteAllDatabasesAsyncWorker(CosmosClient client)
        {
            ...
            FeedIterator<DatabaseProperties> resultSetIterator = client.GetDatabaseIterator(requestOptions: new FeedRequestOptions() { MaxItemCount = 10 });
        ...
        public static async Task DeleteDatabaseCollectionAsync(CosmosClient client, Cosmos.Database database)
        {
            ...
            FeedIterator<ContainerProperties> resultSetIterator = database.GetContainerIterator(requestOptions: new FeedRequestOptions() { MaxItemCount = 10 });
            while (resultSetIterator.HasMoreResults)
            {
