...
namespace Microsoft.Azure.Cosmos.SDK.EmulatorTests
{
    ...
    public class CosmosJsonSerializerTests : BaseCosmosClientHelper
    {
        ...
        public async Task TestCustomJsonSerializer()
        {
            ...
            ItemResponse<ToDoActivity> response = await mockContainer.CreateItemAsync<ToDoActivity>(item: testItem, requestOptions: new ItemRequestOptions { PartitionKey = testItem.status });
            Assert.IsNotNull(response);
