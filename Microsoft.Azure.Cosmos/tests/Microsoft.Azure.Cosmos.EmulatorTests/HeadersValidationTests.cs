    ...
    public class HeadersValidationTests
    {
        ...
        private async Task ValidateCollectionIndexProgressHeaders(CosmosClient client)
        {
            ...
            try
            {
                ...
                {
                    CosmosContainerResponse collectionResponse = await lazyContainer.ReadAsync(requestOptions: new ContainerRequestOptions { PopulateQuotaInfo = true });
                ...
                {
                    CosmosContainerResponse collectionResponse = await consistentContainer.ReadAsync(requestOptions: new ContainerRequestOptions { PopulateQuotaInfo = true });
                ...
                {
                    CosmosContainerResponse collectionResponse = await noneIndexContainer.ReadAsync(requestOptions: new ContainerRequestOptions { PopulateQuotaInfo = true });
                    Assert.IsFalse(collectionResponse.Headers.AllKeys().Contains(HttpConstants.HttpHeaders.CollectionLazyIndexingProgress),
