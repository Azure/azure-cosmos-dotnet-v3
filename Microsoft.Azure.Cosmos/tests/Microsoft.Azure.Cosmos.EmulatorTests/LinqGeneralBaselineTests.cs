...
namespace Microsoft.Azure.Cosmos.Services.Management.Tests.LinqProviderTests
{
    ...
    public class LinqGeneralBaselineTests : BaselineTests<LinqTestInput, LinqTestOutput>
    {
        ...
        public async Task ValidateLinqQueries()
        {
            ...
            IOrderedQueryable<Family> query = container.GetItemsQuery<Family>(allowSynchronousQueryExecution : true);
            ...
            var guid = container.GetItemsQuery<GuidClass>(allowSynchronousQueryExecution: true);
            ...
            var listArrayQuery = container.GetItemsQuery<ListArrayClass>(allowSynchronousQueryExecution : true);
            ...
            var docQuery = from book in container.GetItemsQuery<Document>(allowSynchronousQueryExecution : true)
            ...
            IOrderedQueryable<GreatGreatFamily> queryable = container.GetItemsQuery<GreatGreatFamily>(allowSynchronousQueryExecution : true);
            ...
            var sportQuery = container.GetItemsQuery<Sport>(allowSynchronousQueryExecution : true);
            ...
            var sport2Query = container.GetItemsQuery<Sport2>(allowSynchronousQueryExecution: true);
        ...
        public void ValidateDynamicDocumentQuery() //Ensure query on custom property of document.
        {
            ...
            IOrderedQueryable<Book> bookDocQuery = testContainer.GetItemsQuery<Book>(allowSynchronousQueryExecution : true);
        ...
        {
            IOrderedQueryable<SpecialAttachment2> attachmentQuery = testContainer.GetItemsQuery<SpecialAttachment2>(allowSynchronousQueryExecution : true);
        ...
        private class QueryHelper
        {
            ...
            {
                var query = this.container.GetItemsQuery<T>(allowSynchronousQueryExecution : true)
        ...
        public async Task ValidateLinqOnDataDocumentType()
        {
            ...
            IOrderedQueryable<DataDocument> q = container.GetItemsQuery<DataDocument>(allowSynchronousQueryExecution : true);
        ...
        private async Task ValidateServerSideQueryEvalWithPaginationScenario()
        {
            ...
            IOrderedQueryable<Book> linqQueryable = collection.GetItemsQuery<Book>(allowSynchronousQueryExecution : true);
