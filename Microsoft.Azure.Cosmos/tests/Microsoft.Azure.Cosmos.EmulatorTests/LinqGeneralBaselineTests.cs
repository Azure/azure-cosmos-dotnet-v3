...
namespace Microsoft.Azure.Cosmos.Services.Management.Tests.LinqProviderTests
{
    ...
    public class LinqGeneralBaselineTests : BaselineTests<LinqTestInput, LinqTestOutput>
    {
        ...
        public async Task ValidateLinqQueries()
        {
            ...
            IOrderedQueryable<Family> query = container.GetItemsLinq<Family>(allowSynchronousQueryExecution : true);
            ...
            var guid = container.GetItemsLinq<GuidClass>(allowSynchronousQueryExecution: true);
            ...
            var listArrayQuery = container.GetItemsLinq<ListArrayClass>(allowSynchronousQueryExecution : true);
            ...
            var docQuery = from book in container.GetItemsLinq<Document>(allowSynchronousQueryExecution : true)
            ...
            IOrderedQueryable<GreatGreatFamily> queryable = container.GetItemsLinq<GreatGreatFamily>(allowSynchronousQueryExecution : true);
            ...
            var sportQuery = container.GetItemsLinq<Sport>(allowSynchronousQueryExecution : true);
            ...
            var sport2Query = container.GetItemsLinq<Sport2>(allowSynchronousQueryExecution: true);
        ...
        public void ValidateDynamicDocumentQuery() //Ensure query on custom property of document.
        {
            ...
            IOrderedQueryable<Book> bookDocQuery = testContainer.GetItemsLinq<Book>(allowSynchronousQueryExecution : true);
        ...
        {
            IOrderedQueryable<SpecialAttachment2> attachmentQuery = testContainer.GetItemsLinq<SpecialAttachment2>(allowSynchronousQueryExecution : true);
        ...
        private class QueryHelper
        {
            ...
            {
                var query = this.container.GetItemsLinq<T>(allowSynchronousQueryExecution : true)
        ...
        public async Task ValidateLinqOnDataDocumentType()
        {
            ...
            IOrderedQueryable<DataDocument> q = container.GetItemsLinq<DataDocument>(allowSynchronousQueryExecution : true);
        ...
        private async Task ValidateServerSideQueryEvalWithPaginationScenario()
        {
            ...
            IOrderedQueryable<Book> linqQueryable = collection.GetItemsLinq<Book>(allowSynchronousQueryExecution : true);
