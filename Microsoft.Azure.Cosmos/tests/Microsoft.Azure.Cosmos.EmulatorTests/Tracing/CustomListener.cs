...
namespace Microsoft.Azure.Cosmos.Tests
{
    ...
    /// </summary>
    internal class CustomListener : IObserver<KeyValuePair<string, object>> // Override IObserver to capture Activity events
    {
        private readonly CustomEventListener eventListener;
        ...
        {
            Console.WriteLine($"CustomListener COnstructor : {filter} {eventName}");
            this.eventListener = new CustomEventListener(eventName);
        }
        ...
        public void OnNext(KeyValuePair<string, object> value)
        {
            ...
            lock (this.Scopes)
            {
                ...
                if (value.Key.EndsWith(startSuffix))
                {
                   ...
                   // Console.WriteLine($"CustomListener: Adding Scope {name}");
                ...
                else if (value.Key.EndsWith(stopSuffix))
                {
                    ...
                    foreach (ProducedDiagnosticScope producedDiagnosticScope in this.Scopes)
                    {
                        if (producedDiagnosticScope.Activity.Id == Activity.Current.Id)
                        {
                           ...
                           // Console.WriteLine($"CustomListener: Stopping Scope {name}");
