...
namespace Microsoft.Azure.Cosmos.SDK.EmulatorTests
{
    ...
    public class ClientTelemetryTests : BaseCosmosClientHelper
    {
        ...
        private static readonly AccountClientConfiguration clientConfig = new AccountClientConfiguration
        {
        ...
        public void TestInitialize()
        {
            ...
            this.httpHandler = new HttpClientHandlerHelper
            {
                RequestCallBack = (request, cancellation) =>
                {
                    ...
                    else if (request.RequestUri.AbsoluteUri.Equals(telemetryEndpoint))
                    {
                        HttpResponseMessage result = new HttpResponseMessage(HttpStatusCode.OK);
