    ...
    public class ClientTelemetryTests : BaseCosmosClientHelper
    {
        ...
        public void TestInitialize()
        {
            ...
            this.cosmosClientBuilder = this.GetBuilder()
                                                .WithApplicationPreferredRegions(ClientTelemetryTests.preferredRegionList);
        }

        public virtual Task<HttpResponseMessage> HttpHandlerRequestCallbackChecks(HttpRequestMessage request) 
        {
            if (request.RequestUri.AbsoluteUri.Equals(ClientTelemetryOptions.GetClientTelemetryEndpoint().AbsoluteUri))
            {
        ...
        public virtual CosmosClientBuilder GetBuilder()
        {
            ...
            bool isExpectedNetworkTelemetry = true)
        {
            ...
            {
                ClientTelemetryTests.expectedMetricNameUnitMap.TryAdd(ClientTelemetryOptions.NumberOfTcpConnectionName, ClientTelemetryOptions.NumberOfTcpConnectionUnit);
            }
            else
            {
                ClientTelemetryTests.expectedMetricNameUnitMap.Remove(ClientTelemetryOptions.NumberOfTcpConnectionName);
            }
            ...
            ClientTelemetryTests.AssertSystemLevelInformation(actualSystemInformation, ClientTelemetryTests.expectedMetricNameUnitMap);
