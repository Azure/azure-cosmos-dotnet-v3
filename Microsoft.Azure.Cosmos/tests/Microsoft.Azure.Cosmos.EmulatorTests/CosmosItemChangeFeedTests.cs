    ...
    public class CosmosItemChangeFeedTests : BaseCosmosClientHelper
    {
        ...
        private class CosmosChangeFeedResultSetIteratorCoreMock : StandByFeedIteratorCore
        {
                    ...
                    options: options)
            {
                ...
                this.compositeContinuationToken = StandByFeedContinuationToken.CreateAsync("containerRid", serialized, (string containerRid, Documents.Routing.Range<string> ranges, ITrace trace, PartitionKeyDefinition partitionKeyDefinition, bool forceRefresh) =>
                {
