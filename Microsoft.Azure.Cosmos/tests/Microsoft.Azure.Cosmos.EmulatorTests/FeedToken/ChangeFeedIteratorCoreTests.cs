    ...
    public class ChangeFeedIteratorCoreTests : BaseCosmosClientHelper
    {
            ...
            bool useGateway)
        {
            ...
            while (fullFidelityIterator.HasMoreResults)
            {
                ...
                foreach (ChangeFeedItem<Document> item in feedResponse)
                {
                    Assert.AreEqual(expected: "id3", actual: item.Metadata.DeletedItemId.ToString());
                ...
                changeFeedMode: ChangeFeedMode.AllVersionsAndDeletes))
            {
                ...
                while (feedIterator.HasMoreResults)
                {
                    ...
                    else
                    {
                        ...
                        Assert.AreEqual(expected: id, actual: deleteOperation.Metadata.DeletedItemId.ToString());
