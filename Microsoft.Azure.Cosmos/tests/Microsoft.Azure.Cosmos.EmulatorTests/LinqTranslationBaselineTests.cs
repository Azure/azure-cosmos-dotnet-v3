...
namespace Microsoft.Azure.Cosmos.Services.Management.Tests.LinqProviderTests
{
    ...
    public class LinqTranslationBaselineTests : BaselineTests<LinqTestInput, LinqTestOutput>
    {
        ...
        public void TestLiteralSerialization()
        {
            ...
            var constantQuery = testContainer.GetItemsLinqQueryable<DataObject>(allowSynchronousQueryExecution : true);
        ...
        public void TestTypeCheckFunctions()
        {
            ...
            var query = testContainer.GetItemsLinqQueryable<DataObject>(allowSynchronousQueryExecution : true);
        ...
        {
            var testQuery = testContainer.GetItemsLinqQueryable<DataObject>(allowSynchronousQueryExecution : true);
