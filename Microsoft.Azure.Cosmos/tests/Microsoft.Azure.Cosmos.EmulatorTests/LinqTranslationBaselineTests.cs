...
namespace Microsoft.Azure.Cosmos.Services.Management.Tests.LinqProviderTests
{
    ...
    public class LinqTranslationBaselineTests : BaselineTests<LinqTestInput, LinqTestOutput>
    {
        ...
        public void TestLiteralSerialization()
        {
            ...
            var constantQuery = testContainer.GetItemsLinq<DataObject>(allowSynchronousQueryExecution : true);
        ...
        public void TestTypeCheckFunctions()
        {
            ...
            var query = testContainer.GetItemsLinq<DataObject>(allowSynchronousQueryExecution : true);
        ...
        {
            var testQuery = testContainer.GetItemsLinq<DataObject>(allowSynchronousQueryExecution : true);
