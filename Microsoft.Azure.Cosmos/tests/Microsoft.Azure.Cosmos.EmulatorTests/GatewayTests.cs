...
#region durable scripts
        ...
        */
        ...
        public async Task ValidateIndexingDirectives()
        {
            ...
            FeedIterator<Document> queriedDocuments = collection.GetItemsQueryIterator<Document>(sqlQueryText : @"select * from root r where r.StringField=""222""", maxConcurrency: 1, requestOptions : new QueryRequestOptions { EnableCrossPartitionQuery = true});
            ...
            Logger.LogLine("Querying Document to ensure if document is not indexed");
            queriedDocuments = collection.GetItemsQueryIterator<Document>(sqlQueryText: @"select * from root r where r.StringField=""222""", maxConcurrency: 1, requestOptions: new QueryRequestOptions { EnableCrossPartitionQuery = true });
