...
if "%TEST_BASELINE_PATH%"=="" (
  if EXIST "bin\Debug\netcoreapp2.0\PreviewDotNetSDKAPI.json" (
...
if "%TEST_OUTPUT_PATH%"=="" (
  if EXIST "bin\Debug\netcoreapp2.0\PreviewDotNetSDKAPIChanges.json" (
...
call windiff "%TEST_BASELINE_PATH%\PreviewDotNetSDKAPI.json" "%TEST_OUTPUT_PATH%\PreviewDotNetSDKAPIChanges.json"
...
echo xcopy "%TEST_OUTPUT_PATH%\PreviewDotNetSDKAPIChanges.json" "%TEST_BASELINE_SOURCE_PATH%\PreviewDotNetSDKAPI.json" /Q /Y
xcopy "%TEST_OUTPUT_PATH%\PreviewDotNetSDKAPIChanges.json" "%TEST_BASELINE_SOURCE_PATH%\PreviewDotNetSDKAPI.json" /Q /Y 
