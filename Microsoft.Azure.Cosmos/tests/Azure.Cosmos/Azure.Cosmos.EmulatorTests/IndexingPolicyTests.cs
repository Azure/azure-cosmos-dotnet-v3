...
namespace Azure.Cosmos.EmulatorTests
{
    ...
    public class IndexingPolicyTests
    {
        ...
        /// </summary>
        private static readonly CosmosClient cosmosClient = TestCommon.CreateCosmosClient();

        /// <summary>
        /// The database used for all the tests.
        /// </summary>
        private static readonly Cosmos.CosmosDatabase database = cosmosClient.CreateDatabaseAsync(Guid.NewGuid().ToString()).Result;
