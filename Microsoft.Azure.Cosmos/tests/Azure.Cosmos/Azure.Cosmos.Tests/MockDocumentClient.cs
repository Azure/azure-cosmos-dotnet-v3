...
namespace Azure.Cosmos.Tests
{
    ...
    internal class MockDocumentClient : DocumentClient, IAuthorizationTokenProvider
    {
        ...
        public MockDocumentClient(Uri serviceEndpoint, SecureString authKey, ConnectionPolicy connectionPolicy = null, Microsoft.Azure.Documents.ConsistencyLevel? desiredConsistencyLevel = null)
            : base(serviceEndpoint, authKey, connectionPolicy, desiredConsistencyLevel)
        {
            this.Init();
        }

        public MockDocumentClient(Uri serviceEndpoint, string authKeyOrResourceToken, ConnectionPolicy connectionPolicy = null, Microsoft.Azure.Documents.ConsistencyLevel? desiredConsistencyLevel = null)
            : base(serviceEndpoint, authKeyOrResourceToken, (HttpMessageHandler)null, connectionPolicy, desiredConsistencyLevel)
        {
            this.Init();
        }

        public MockDocumentClient(Uri serviceEndpoint, IList<Microsoft.Azure.Documents.Permission> permissionFeed, ConnectionPolicy connectionPolicy = null, Microsoft.Azure.Documents.ConsistencyLevel? desiredConsistencyLevel = null)
            : base(serviceEndpoint, permissionFeed, connectionPolicy, desiredConsistencyLevel)
        {
            this.Init();
        }

        public MockDocumentClient(Uri serviceEndpoint, SecureString authKey, JsonSerializerSettings serializerSettings, ConnectionPolicy connectionPolicy = null, Microsoft.Azure.Documents.ConsistencyLevel? desiredConsistencyLevel = null)
            : base(serviceEndpoint, authKey, serializerSettings, connectionPolicy, desiredConsistencyLevel)
        {
            this.Init();
        }

        public MockDocumentClient(Uri serviceEndpoint, string authKeyOrResourceToken, JsonSerializerSettings serializerSettings, ConnectionPolicy connectionPolicy = null, Microsoft.Azure.Documents.ConsistencyLevel? desiredConsistencyLevel = null)
            : base(serviceEndpoint, authKeyOrResourceToken, serializerSettings, connectionPolicy, desiredConsistencyLevel)
        {
            this.Init();
        }

        internal MockDocumentClient(Uri serviceEndpoint, IList<ResourceToken> resourceTokens, ConnectionPolicy connectionPolicy = null, Microsoft.Azure.Documents.ConsistencyLevel? desiredConsistencyLevel = null)
        ...
        public override Microsoft.Azure.Documents.ConsistencyLevel ConsistencyLevel => Microsoft.Azure.Documents.ConsistencyLevel.Session;
        ...
        internal virtual IReadOnlyList<PartitionKeyRange> ResolveOverlapingPartitionKeyRanges(string collectionRid, Microsoft.Azure.Documents.Routing.Range<string> range, bool forceRefresh)
        {
            return (IReadOnlyList<PartitionKeyRange>) new List<Microsoft.Azure.Documents.PartitionKeyRange>() {new Microsoft.Azure.Documents.PartitionKeyRange() { MinInclusive = "", MaxExclusive = "FF", Id = "0" } };
        }
        ...
        private void Init()
        {
            ...
            this.partitionKeyRangeCache.Setup(
                        m => m.TryGetOverlappingRangesAsync(
                            It.IsAny<string>(),
                            It.IsAny<Microsoft.Azure.Documents.Routing.Range<string>>(),
                            It.IsAny<bool>()
                        )
                ).Returns((string collectionRid, Microsoft.Azure.Documents.Routing.Range<string> range, bool forceRefresh) =>
                {
