...
namespace Azure.Cosmos.Tests
{
    ...
    public class DirectContractTests
    {
        ...
        {
            Trace.TraceInformation($"{Microsoft.Azure.Documents.RMResources.PartitionKeyAndEffectivePartitionKeyBothSpecified} " +
                $"{Microsoft.Azure.Documents.RMResources.UnexpectedPartitionKeyRangeId}");
        }
        ...
        {
            string csprojFile = "Azure.Cosmos.csproj";
