...
namespace Microsoft.Azure.Cosmos.Tests.Routing
{
    ...
    public class MetadataHedgingRegionalFailureTests
    {
        ...
        {
            Assert.IsTrue(MetadataRegionalFailureClassifier.IsRegionalFailure(
                statusCode: null,
        ...
        public void IsRegionalFailure_UserOperationCanceled_ReturnsFalse()
        {
            ...
            cts.Cancel();
            Assert.IsFalse(MetadataRegionalFailureClassifier.IsRegionalFailure(
                statusCode: null,
                subStatus: SubStatusCodes.Unknown,
                exception: new OperationCanceledException(),
        ...
        {
            Assert.AreEqual(expected, MetadataRegionalFailureClassifier.IsRegionalFailure(
