...
namespace Microsoft.Azure.Cosmos
{
    ...
    public class VmMetadataApiHandlerTest
    {
        ...
        [DataRow(false, false)]
        [DataRow(false, true)]
        public async Task GetVmIdAsMachineIdTest(bool isVmMetadataAccessDisabled, bool isDebuggerAttached)
        {
            if (isVmMetadataAccessDisabled)
            {
                Environment.SetEnvironmentVariable("COSMOS_DISABLE_VM_METADATA_ACCESS", "true");
            }
            ...
            if (isVmMetadataAccessDisabled || isDebuggerAttached)
            {
                ...
                Environment.SetEnvironmentVariable("COSMOS_DISABLE_VM_METADATA_ACCESS", "false");
            }
            else
            {
