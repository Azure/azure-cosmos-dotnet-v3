...
namespace Microsoft.Azure.Cosmos.Tests
{
    ...
    public class ItemBatchOperationStatisticsTests
    {
        ...
        public void ToString_ReturnItemsToString()
        {
            ...
            PointOperationStatistics pointOperation1 = new PointOperationStatistics(Guid.NewGuid().ToString(), HttpStatusCode.OK, SubStatusCodes.Unknown, 0, string.Empty, HttpMethod.Get, "http://localhost", cosmosClientSideRequestStatistics1);
            ...
            PointOperationStatistics pointOperation2 = new PointOperationStatistics(Guid.NewGuid().ToString(), HttpStatusCode.OK, SubStatusCodes.Unknown, 0, string.Empty, HttpMethod.Get, "http://localhost", cosmosClientSideRequestStatistics2);
