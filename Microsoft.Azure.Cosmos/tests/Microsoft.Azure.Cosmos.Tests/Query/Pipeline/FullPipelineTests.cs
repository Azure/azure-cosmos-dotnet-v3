    ...
    public class FullPipelineTests
    {
            ...
            QueryRequestOptions queryRequestOptions)
        {
            ...
            mockClient.Setup(x => x.GetTargetPartitionKeyRangesAsync(
                ...
                .Returns((string resourceLink, string collectionResourceId, IReadOnlyList<Documents.Routing.Range<string>> providedRanges, bool forceRefresh, ITrace trace, CancellationToken ct) => Task.FromResult(partitionKeyRanges));
