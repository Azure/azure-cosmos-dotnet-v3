...
namespace Microsoft.Azure.Cosmos.Tests.Query
{
    ...
    public class QueryPlanRetrieverTests
    {
        ...
        public async Task SanityTests()
        {
            ...
            // Test cases to be added after direct package upgrade
            TestCase[] _ = new TestCase[]
            {
                MakeTest(
