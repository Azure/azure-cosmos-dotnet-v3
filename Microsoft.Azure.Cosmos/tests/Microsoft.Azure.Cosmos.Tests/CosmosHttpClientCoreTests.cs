...
namespace Microsoft.Azure.Cosmos.Tests
{
    ...
    public class CosmosHttpClientCoreTests
    {
        ...
        [TestMethod]
        public async Task HttpTimeouPolicytRetriesTestAsync()
        {
            ...
            await TestScenarioAsync(HttpMethod.Get, ResourceType.Document, OperationType.QueryPlan, HttpTimeoutPolicyControlPlaneRetriableHotPath.InstanceShouldThrow503OnTimeout, typeof(CosmosException), 3);

            await TestScenarioAsync(HttpMethod.Post, ResourceType.Document, OperationType.Upsert, HttpTimeoutPolicyControlPlaneRetriableHotPath.InstanceShouldThrow503OnTimeout, typeof(CosmosException), 1);

            await TestScenarioAsync(HttpMethod.Get, ResourceType.PartitionKeyRange, OperationType.ReadFeed, HttpTimeoutPolicyControlPlaneRetriableHotPath.InstanceShouldThrow503OnTimeout, typeof(CosmosException), 3);

            await TestScenarioAsync(HttpMethod.Post, ResourceType.PartitionKeyRange, OperationType.Upsert, HttpTimeoutPolicyControlPlaneRetriableHotPath.InstanceShouldThrow503OnTimeout, typeof(CosmosException), 1);

            await TestScenarioAsync(HttpMethod.Get, ResourceType.Address, OperationType.Read, HttpTimeoutPolicyControlPlaneRetriableHotPath.InstanceShouldThrow503OnTimeout, typeof(CosmosException), 3);

            await TestScenarioAsync(HttpMethod.Post, ResourceType.Address, OperationType.Upsert, HttpTimeoutPolicyControlPlaneRetriableHotPath.InstanceShouldThrow503OnTimeout, typeof(CosmosException), 3);

            await TestScenarioAsync(HttpMethod.Get, ResourceType.Document, OperationType.Read, HttpTimeoutPolicyForThinClient.InstanceShouldRetryAndThrow503OnTimeout, typeof(CosmosException), 3);

            await TestScenarioAsync(HttpMethod.Post, ResourceType.Document, OperationType.Upsert, HttpTimeoutPolicyForThinClient.InstanceShouldRetryAndThrow503OnTimeout, typeof(CosmosException), 1);

            await TestScenarioAsync(HttpMethod.Post, ResourceType.Document, OperationType.Upsert, HttpTimeoutPolicyForThinClient.InstanceShouldRetryAndThrow503OnTimeout, typeof(CosmosException), 1);

            await TestScenarioAsync(HttpMethod.Get, ResourceType.Document, OperationType.Read, HttpTimeoutPolicyForPartitionFailover.InstanceShouldThrow503OnTimeout, typeof(CosmosException), 3);
