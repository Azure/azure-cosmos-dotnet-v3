...
namespace Microsoft.Azure.Cosmos.Tests
{
    ...
    public class HeadersTests
    {
        ...
        {
            Headers Headers = new Headers();
            Headers.RequestHeaders[Key] = Guid.NewGuid().ToString();
            Headers.RequestHeaders.Clear();
            Assert.IsNull(Headers[Key]);
        }
        ...
        public void TestCount()
        {
            Headers Headers = new Headers();
            Headers.RequestHeaders[Key] = Guid.NewGuid().ToString();
            Assert.AreEqual(1, Headers.RequestHeaders.Count());
        }
        ...
        public void TestGetToNameValueCollection()
        {
            ...
            string value = Guid.NewGuid().ToString();
            Headers.RequestHeaders[Key] = value;
            NameValueCollection anotherCollection = Headers.RequestHeaders.ToNameValueCollection();
        ...
        public void TestSetAndGetKnownProperties()
        {
            // Most commonly used in the Request
            {
                ...
                Headers.RequestHeaders[HttpConstants.HttpHeaders.Continuation] = value1;
                Headers.RequestHeaders[HttpConstants.HttpHeaders.PartitionKey] = value2;
                Headers.RequestHeaders[WFConstants.BackendHeaders.PartitionKeyRangeId] = value3;
                Assert.AreEqual(value1, Headers.ContinuationToken);
                Assert.AreEqual(value2, Headers.PartitionKey);
                Assert.AreEqual(value3, Headers.PartitionKeyRangeId);
                Assert.AreEqual(value1, Headers[HttpConstants.HttpHeaders.Continuation]);
            ...
            // Most commonly used in the Response
            {
                ...
                requestHeaders.RequestHeaders[HttpConstants.HttpHeaders.Continuation] = value1;
                requestHeaders.RequestHeaders[WFConstants.BackendHeaders.SubStatus] = value2;
                requestHeaders.RequestHeaders[HttpConstants.HttpHeaders.RetryAfterInMilliseconds] = value3;
                requestHeaders.RequestHeaders[HttpConstants.HttpHeaders.SessionToken] = value4;
        ...
        public void TestClearWithKnownProperties()
        {
            ...
            Headers.RequestHeaders[HttpConstants.HttpHeaders.RetryAfterInMilliseconds] = "20";
            Headers.RequestHeaders.Clear();
            Assert.IsNull(Headers[Key]);
        ...
        public void TestCountWithKnownProperties()
        {
            ...
            Headers.ContinuationToken = Guid.NewGuid().ToString();
            Headers.RequestHeaders[HttpConstants.HttpHeaders.RetryAfterInMilliseconds] = "20";
            Assert.AreEqual(4, Headers.RequestHeaders.Count());
        }
