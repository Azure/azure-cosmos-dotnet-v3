...
namespace Microsoft.Azure.Cosmos.ChangeFeed.Tests
{
    ...
    public class DocumentServiceLeaseUpdaterCosmosTests
    {
        ...
        public async Task UpdatesLease()
        {
            ...
            var updater = new DocumentServiceLeaseUpdaterCosmos(DocumentServiceLeaseUpdaterCosmosTests.GetMockedContainer());
        ...
        private static CosmosContainerCore GetMockedContainer()
        {
