...
namespace Microsoft.Azure.Cosmos.ChangeFeed.Tests
{
    ...
    public class ChangeFeedProcessorBuilderTests
    {
        ...
        private static Action<DocumentServiceLeaseStoreManager, CosmosContainer, string, ChangeFeedLeaseOptions, ChangeFeedProcessorOptions, CosmosContainer> GetEmptyInitialization()
        {
