...
namespace Microsoft.Azure.Cosmos.ChangeFeed.Tests
{
    ...
    public class FeedReadSessionNotAvailableExceptionTests
    {
        [TestMethod]
        ...
        {
            FeedReadSessionNotAvailableException originalException = new FeedReadSessionNotAvailableException("message", "continuation", new Exception("foo"));
