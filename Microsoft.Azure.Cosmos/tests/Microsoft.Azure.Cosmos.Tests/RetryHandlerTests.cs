...
namespace Microsoft.Azure.Cosmos.Tests
{
    ...
    public class RetryHandlerTests
    {
        ...
        public async Task RetryHandlerDoesNotRetryOnSuccess()
        {
            ...
            RequestInvokerHandler invoker = new RequestInvokerHandler(client.DocumentClient.GetCollectionCacheAsync, client.GetAccountConsistencyLevelAsync, client.DocumentClient.EnsureValidClientAsync, client.DocumentClient.UseMultipleWriteLocations, client.ClientOptions);
        ...
        public async Task PartitionKeyRangeGoneRetryHandlerOnSuccess()
        {
            ...
            PartitionKeyRangeGoneRetryHandler retryHandler = new PartitionKeyRangeGoneRetryHandler(client.DocumentClient.GetPartitionKeyRangeCacheAsync, client.DocumentClient.GetCollectionCacheAsync);
            int handlerCalls = 0;
            int expectedHandlerCalls = 1;
            TestHandler testHandler = new TestHandler((request, cancellationToken) => {
                handlerCalls++;
