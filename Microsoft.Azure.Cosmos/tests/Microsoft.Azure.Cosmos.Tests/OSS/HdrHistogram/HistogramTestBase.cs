...
namespace HdrHistogram.UnitTests
{
    public abstract class HistogramTestBase
    {
        ...
        internal abstract HistogramBase Create(long highestTrackableValue, int numberOfSignificantValueDigits);
        internal abstract HistogramBase Create(long lowestTrackableValue, long highestTrackableValue, int numberOfSignificantValueDigits);
