...
namespace Microsoft.Azure.Cosmos
{
    ...
    public class CosmosContainerSettingsTests
    {
        ...
        public void ValidateSerialization()
        {
            ...
            CosmosContainerProperties containerSettings = new CosmosContainerProperties("TestContainer", "/partitionKey");
            Stream basic = jsonSerializer.ToStream<CosmosContainerProperties>(containerSettings);
            CosmosContainerProperties response = jsonSerializer.FromStream<CosmosContainerProperties>(basic);
        ...
        private static void AssertSerializedPayloads(CosmosContainerProperties settings, DocumentCollection documentCollection)
        {
