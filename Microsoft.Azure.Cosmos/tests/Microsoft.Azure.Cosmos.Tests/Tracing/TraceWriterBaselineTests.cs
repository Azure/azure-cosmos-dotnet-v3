            ...
            {
                {
                    ...
                    using (rootTrace = TraceForBaselineTesting.GetRootTrace())
                    {
                        ...
                        datum.AppendContactedReplica(uri1);
                        datum.AppendContactedReplica(uri2);
                        ...
                        datum.AppendFailedReplica(uri1);
                        datum.AppendFailedReplica(uri2);

                        datum.AppendRegionContacted("local", uri1.Uri);
                        datum.AppendRegionContacted("local", uri2.Uri);
...

                {
                    ...
                    {
                        ClientSideRequestStatisticsTraceDatum datum = new ClientSideRequestStatisticsTraceDatum(DateTime.MinValue, rootTrace);
                        datum.AppendContactedReplica(default);
                        ...
                        datum.AppendFailedReplica(default);

                        datum.AppendRegionContacted(default, default);
