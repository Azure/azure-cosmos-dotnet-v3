...
namespace Microsoft.Azure.Cosmos.Scenarios
{
    ...
    /// </summary>
    [TestClass]
    public sealed class GremlinScenarioTests_Text : GremlinScenarioTests
    {
        internal override JsonSerializationFormat SerializationFormat => JsonSerializationFormat.Text;
    }
}