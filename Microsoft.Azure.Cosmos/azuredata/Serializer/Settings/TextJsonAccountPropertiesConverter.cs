...
namespace Azure.Cosmos
{
    ...
    {
        public override AccountProperties Read(ref Utf8JsonReader reader, Type typeToConvert, JsonSerializerOptions options)
        {
        ...
        public override void Write(Utf8JsonWriter writer, AccountProperties setting, JsonSerializerOptions options)
        {
        ...
        private static void ReadPropertyValue(AccountProperties setting, JsonProperty property)
        {
