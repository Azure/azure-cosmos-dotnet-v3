...
namespace Azure.Cosmos
{
    ...
    internal class CosmosOffers
    {
            ...
            CancellationToken cancellationToken = default(CancellationToken))
        {
            ...
            if (offerV2 == null)
            {
                return new ThroughputResponse(null, null);
            }
            ...
            CancellationToken cancellationToken = default(CancellationToken))
        {
            ...
            {
                Response responseMessage = dce.ToCosmosResponseMessage(null);
        ...
        private async Task<ThroughputResponse> GetThroughputResponseAsync(
           ...
           CancellationToken cancellationToken = default(CancellationToken))
        {
            Task<Response> responseMessage = this.ClientContext.ProcessResourceOperationStreamAsync(
              resourceUri: linkUri,
              resourceType: resourceType,
              operationType: operationType,
            ...
            return await this.ClientContext.ResponseFactory.CreateThroughputResponseAsync(responseMessage, cancellationToken);
        }
