...
namespace Microsoft.Azure.Cosmos
{
    ...
    internal sealed class ConnectionPolicy
    {
        ...
        /// </value>
        /// <remarks>
        /// This setting is not used when <see cref="ConnectionMode"/> is set to <see cref="
        ...
        /// <summary>
        /// Gets or sets the <see cref="Microsoft.Azure.Cosmos.RetryOptions"/> associated
        ...
        /// <para>
        /// <see cref="Microsoft.Azure.Cosmos.RetryOptions.MaxRetryAttemptsOnThrottledRequests"/> is set to 3, so in this case, if a request operation is rate limited by exceeding the reserved 
        /// throughput for the collection, the request operation retries 3 times before throwing the exception to the application.
        /// <see cref="Microsoft.Azure.Cosmos.RetryOptions.MaxRetryWaitTimeInSeconds"/> is set to 60, so in this case if the cumulative retry 
        ...
        /// </example>
        /// <value>
        /// If this property is not set, the SDK uses the default retry policy that has <see cref="Microsoft.Azure.Cosmos.RetryOptions.MaxRetryAttemptsOnThrottledRequests"/>
        /// set to 9 and <see cref="Microsoft.Azure.Cosmos.RetryOptions.MaxRetryWaitTimeInSeconds"/> set to 30 seconds.
        /// </value>
        /// <remarks>
