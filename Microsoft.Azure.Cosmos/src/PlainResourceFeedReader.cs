...
namespace Microsoft.Azure.Cosmos
{
    ...
    internal sealed class PlainResourceFeedReader<T> : IEnumerable<T>
    {
        private readonly DocumentQuery<T> documentQuery;

        internal PlainResourceFeedReader(DocumentClient client, ResourceType resourceType, FeedOptions options, string resourceLink, object partitionKey = null)
        {
