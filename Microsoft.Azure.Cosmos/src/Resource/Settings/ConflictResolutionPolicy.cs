...
namespace Microsoft.Azure.Cosmos
{
    ...
    internal sealed class ConflictResolutionPolicy : JsonSerializable
    {
        ...
        /// If the path is unspecified, by default the <see cref="CosmosResource.Timestamp"/> path will be used.
        /// </summary>
        /// <remarks>
        ...
        /// This stored procedure may be created after the <see cref="CosmosContainerSettings"/> is created and can be changed as required. 
        /// </summary>
        /// <remarks>
        ...
        /// 3. The user can provide the stored procedure <see cref="CosmosResource.Id"/> or <see cref="CosmosResource.ResourceId"/>.
        /// </remarks>
        /// <value>
