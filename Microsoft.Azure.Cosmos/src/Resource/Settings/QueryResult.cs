...
namespace Microsoft.Azure.Cosmos.Internal
{
    ...
    internal sealed class QueryResult : IDynamicMetaObjectProvider
    {
        ...
        private object Convert(Type type)
        {
            ...
            if (type == typeof(CosmosDatabaseSettings))
            {
                result = new CosmosDatabaseSettings() { propertyBag = this.jObject as JObject };
            }
            else if (type == typeof(CosmosContainerSettings))
            {
                result = new CosmosContainerSettings() { propertyBag = this.jObject as JObject };
            }
            ...
            {
                result = new CosmosTriggerSettings() { propertyBag = this.jObject as JObject };
            }
            ...
            {
                result = (CosmosResource)((this.jsonSerializer == null) ?
            ...
            {
                result = (CosmosResource)this.jObject.ToObject(type);
            ...
            if (resource != null)
            {
                resource.AltLink = DirectExtensions.GeneratePathForNameBased(type, this.ownerFullName, resource.Id);
            }
            return result;
        }
