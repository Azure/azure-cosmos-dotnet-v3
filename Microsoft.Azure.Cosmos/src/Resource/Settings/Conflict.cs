...
namespace Microsoft.Azure.Cosmos.Internal
{
    ...
    /// </remarks>
    internal class Conflict : CosmosResource
    {
        /// <summary>
        ...
        public T GetResource<T>() where T : CosmosResource, new()
        {
        ...
        internal void SetResource<T>(T baseResource) where T : CosmosResource, new()
        {
            if (typeof(T) != this.ResourceType)
            {
                throw new ArgumentException(
        ...
        public OperationKind OperationKind
        {
            get
            {
                ...
                if (string.Equals(Constants.Properties.OperationKindCreate, operationKind, StringComparison.OrdinalIgnoreCase))
                {
                    ...
                    string.Equals(Constants.Properties.OperationKindUpdate, operationKind, StringComparison.OrdinalIgnoreCase))
                {
        ...
        public Type ResourceType
        {
            ...
            internal set
            {
                ...
                else if (value == typeof(CosmosStoredProcedureSettings))
                {
                    resourceType = Constants.Properties.ResourceTypeStoredProcedure;
                }
                else if (value == typeof(CosmosTriggerSettings))
                {
                    resourceType = Constants.Properties.ResourceTypeTrigger;
                }
                else if (value == typeof(CosmosUserDefinedFunctionSettings))
                {
