...
namespace Microsoft.Azure.Cosmos
{
    ...
    /// Processing the change feed with <see cref="ChangeFeedMode.AllOperations"/> will only be able within this retention window - if you attempt to process a change feed after more
