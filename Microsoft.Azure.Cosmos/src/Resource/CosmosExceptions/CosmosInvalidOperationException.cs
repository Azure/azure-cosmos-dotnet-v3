...
namespace Microsoft.Azure.Cosmos
{
    ...
    /// <summary>
    /// The exception is a wrapper for InvalidOperationException. This wrapper
    /// adds a way to access the CosmosDiagnostics and appends additional information
    /// to the message for easier troubleshooting.
    /// </summary>
    internal class CosmosInvalidOperationException : InvalidOperationException
    {
        private readonly InvalidOperationException originalException;

        /// <summary>
        /// Create an instance of CosmosInvalidOperationException
        /// </summary>
        internal CosmosInvalidOperationException(
