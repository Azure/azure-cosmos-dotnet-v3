...
namespace Microsoft.Azure.Cosmos
{
    ...
    public class CosmosException : Exception
    {
                ...
                activityId), innerException)
        {
            ...
            this.DiagnosticsContext = diagnosticsContext ?? new CosmosDiagnosticsContextCore(nameof(CosmosException));
        }
            ...
            : base(message)
        {
            ...
            this.DiagnosticsContext = new CosmosDiagnosticsContextCore(nameof(CosmosException));
        }
