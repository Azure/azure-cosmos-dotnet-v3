...
namespace Microsoft.Azure.Cosmos
{
    ...
    public class ThroughputResponse : Response<ThroughputProperties>
    {
        ...
        public int? MinThroughput
        {
            get
            {
                if (this.CosmosHeaders?.GetHeaderValue<string>(WFConstants.BackendHeaders.MinimumRUsForOffer) != null)
                {
                    return int.Parse(this.CosmosHeaders.GetHeaderValue<string>(WFConstants.BackendHeaders.MinimumRUsForOffer));
                }
                return null;
            }
        }
        ...
        public bool? IsReplacePending
        {
            get
            {
                if (this.CosmosHeaders.GetHeaderValue<string>(WFConstants.BackendHeaders.OfferReplacePending) != null)
                {
                    return Boolean.Parse(this.CosmosHeaders.GetHeaderValue<string>(WFConstants.BackendHeaders.MinimumRUsForOffer));
                }
                return null;
            }
        }
