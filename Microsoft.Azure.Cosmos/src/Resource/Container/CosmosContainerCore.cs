...
namespace Microsoft.Azure.Cosmos
{
    ...
    internal partial class CosmosContainerCore : CosmosContainer
    {
        ...
        internal async Task<CosmosContainerSettings> GetCachedContainerSettingsAsync(CancellationToken cancellation = default)
        {
        ...
        internal Task<PartitionKeyDefinition> GetPartitionKeyDefinitionAsync(CancellationToken cancellation = default)
        {
            return this.GetCachedContainerSettingsAsync(cancellation)
