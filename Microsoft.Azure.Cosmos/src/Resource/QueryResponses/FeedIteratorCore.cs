...
namespace Microsoft.Azure.Cosmos
{
    ...
    internal class FeedIteratorCore : FeedIterator
    {
        ...
        public override async Task<CosmosResponseMessage> FetchNextSetAsync(CancellationToken cancellation = default)
        {
    ...
    internal class FeedIteratorCore<T> : FeedIterator<T>
    {
        ...
        /// <param name="cancellation">(Optional) <see cref="CancellationToken"/> representing request cancellation.</param>
        /// <returns>A query response from cosmos service</returns>
        public override async Task<FeedResponse<T>> FetchNextSetAsync(CancellationToken cancellation = default)
        {
            cancellation.ThrowIfCancellationRequested();

            FeedResponse<T> response = await this.nextResultSetDelegate(this.MaxItemCount, this.continuationToken, this.queryOptions, this.state, cancellation);
