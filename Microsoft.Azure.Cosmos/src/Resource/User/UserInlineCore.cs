    ...
    internal sealed class UserInlineCore : UserCore
    {
            ...
            CancellationToken cancellationToken = default)
        {
            return this.ClientContext.OperationHelperAsync(
                nameof(ReplaceAsync),
                requestOptions,
                (trace, diagnosticAttributes) => base.ReplaceAsync(userProperties, requestOptions, trace, cancellationToken));
        }
            ...
            CancellationToken cancellationToken = default)
        {
            return this.ClientContext.OperationHelperAsync(
                ...
                requestOptions,
                (trace, diagnosticAttributes) => base.CreatePermissionAsync(permissionProperties, tokenExpiryInSeconds, requestOptions, trace, cancellationToken));
        }
            ...
            CancellationToken cancellationToken = default)
        {
            return this.ClientContext.OperationHelperAsync(
                ...
                requestOptions,
                (trace, diagnosticAttributes) => base.UpsertPermissionAsync(permissionProperties, tokenExpiryInSeconds, requestOptions, trace, cancellationToken));
        }
