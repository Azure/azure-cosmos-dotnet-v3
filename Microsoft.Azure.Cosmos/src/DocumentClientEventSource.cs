...
namespace Microsoft.Azure.Cosmos
{
    ...
    internal sealed class DocumentClientEventSource : EventSource, ICommunicationEventSource
    {
...
#pragma warning restore SA1118 // Parameter should not span multiple lines
        ...
        public void Response(Guid activityId, Guid localId, short statusCode, double milliseconds, HttpResponseHeaders responseHeaders)
        {
            if (this.IsEnabled(EventLevel.Verbose, Keywords.HttpRequestAndResponse))
            {
                string[] keysToExtract =
