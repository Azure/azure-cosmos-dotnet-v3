...
#pragma warning restore SA1118 // Parameter should not span multiple lines
            ...
            string xDate)
        {
            ...
            if (consistencyLevel == null) throw new ArgumentNullException(nameof(consistencyLevel));
            if (contentType == null) throw new ArgumentNullException(nameof(contentType));
            if (contentEncoding == null) throw new ArgumentNullException(nameof(contentEncoding));
            if (contentLength == null) throw new ArgumentNullException(nameof(contentLength));
            if (contentLocation == null) throw new ArgumentNullException(nameof(contentLocation));
            if (continuation == null) throw new ArgumentNullException(nameof(continuation));
            if (emitVerboseTracesInQuery == null) throw new ArgumentNullException(nameof(emitVerboseTracesInQuery));
            if (enableScanInQuery == null) throw new ArgumentNullException(nameof(enableScanInQuery));
            if (eTag == null) throw new ArgumentNullException(nameof(eTag));
            if (httpDate == null) throw new ArgumentNullException(nameof(httpDate));
            if (ifMatch == null) throw new ArgumentNullException(nameof(ifMatch));
            if (ifNoneMatch == null) throw new ArgumentNullException(nameof(ifNoneMatch));
            if (indexingDirective == null) throw new ArgumentNullException(nameof(indexingDirective));
            if (keepAlive == null) throw new ArgumentNullException(nameof(keepAlive));
            if (offerType == null) throw new ArgumentNullException(nameof(offerType));
            if (pageSize == null) throw new ArgumentNullException(nameof(pageSize));
            if (preTriggerExclude == null) throw new ArgumentNullException(nameof(preTriggerExclude));
            if (preTriggerInclude == null) throw new ArgumentNullException(nameof(preTriggerInclude));
            if (postTriggerExclude == null) throw new ArgumentNullException(nameof(postTriggerExclude));
            if (postTriggerInclude == null) throw new ArgumentNullException(nameof(postTriggerInclude));
            if (profileRequest == null) throw new ArgumentNullException(nameof(profileRequest));
            if (resourceTokenExpiry == null) throw new ArgumentNullException(nameof(resourceTokenExpiry));
            if (sessionToken == null) throw new ArgumentNullException(nameof(sessionToken));
            if (setCookie == null) throw new ArgumentNullException(nameof(setCookie));
            ...
            if (xDate == null) throw new ArgumentNullException(nameof(xDate));
...
#pragma warning restore SA1118 // Parameter should not span multiple lines
            ...
            string version)
        {
            ...
            if (contentLength == null) throw new ArgumentNullException(nameof(contentLength));
            if (contentLocation == null) throw new ArgumentNullException(nameof(contentLocation));
            if (currentMediaStorageUsageInMB == null) throw new ArgumentNullException(nameof(currentMediaStorageUsageInMB));
            if (currentResourceQuotaUsage == null) throw new ArgumentNullException(nameof(currentResourceQuotaUsage));
            if (databaseAccountConsumedDocumentStorageInMB == null) throw new ArgumentNullException(nameof(databaseAccountConsumedDocumentStorageInMB));
            if (databaseAccountProvisionedDocumentStorageInMB == null) throw new ArgumentNullException(nameof(databaseAccountProvisionedDocumentStorageInMB));
            if (databaseAccountReservedDocumentStorageInMB == null) throw new ArgumentNullException(nameof(databaseAccountReservedDocumentStorageInMB));
            if (gatewayVersion == null) throw new ArgumentNullException(nameof(gatewayVersion));
            if (indexingDirective == null) throw new ArgumentNullException(nameof(indexingDirective));
            if (itemCount == null) throw new ArgumentNullException(nameof(itemCount));
            if (lastStateChangeUtc == null) throw new ArgumentNullException(nameof(lastStateChangeUtc));
            if (maxMediaStorageUsageInMB == null) throw new ArgumentNullException(nameof(maxMediaStorageUsageInMB));
            if (maxResourceQuota == null) throw new ArgumentNullException(nameof(maxResourceQuota));
            if (newResourceId == null) throw new ArgumentNullException(nameof(newResourceId));
            if (ownerFullName == null) throw new ArgumentNullException(nameof(ownerFullName));
            if (ownerId == null) throw new ArgumentNullException(nameof(ownerId));
            if (requestCharge == null) throw new ArgumentNullException(nameof(requestCharge));
            if (requestValidationFailure == null) throw new ArgumentNullException(nameof(requestValidationFailure));
            if (retryAfter == null) throw new ArgumentNullException(nameof(retryAfter));
            if (retryAfterInMilliseconds == null) throw new ArgumentNullException(nameof(retryAfterInMilliseconds));
            if (serverVersion == null) throw new ArgumentNullException(nameof(serverVersion));
            if (schemaVersion == null) throw new ArgumentNullException(nameof(schemaVersion));
            if (sessionToken == null) throw new ArgumentNullException(nameof(sessionToken));
