...
namespace Microsoft.Azure.Cosmos
{
    ...
    public class CosmosClientOptions
    {
        ...
        /// reported as retriable, the SDK will re-issue the commit (with a fresh idempotency token) for
        /// a maximum of 10 attempts before returning the last response to the application.
        ///
