...
namespace Microsoft.Azure.Cosmos
{
    ...
    public abstract class KeyWrapProvider
    {
        ...
        public abstract Task<KeyWrapResponse> WrapKeyAsync(byte[] key, KeyWrapMetadata metadata);
        ...
        public abstract Task<KeyUnwrapResponse> UnwrapKeyAsync(byte[] wrappedKey, KeyWrapMetadata metadata);
    }
}
