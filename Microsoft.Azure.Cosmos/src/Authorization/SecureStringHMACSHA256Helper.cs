...
namespace Microsoft.Azure.Cosmos
{
    ...
    internal sealed class SecureStringHMACSHA256Helper : IComputeHash
    {
        ...
        {
            this.Key = base64EncodedKey ?? throw new ArgumentNullException(nameof(base64EncodedKey));
            // caching the length of SecureString as calling Length method on it every time causes a performance hit
