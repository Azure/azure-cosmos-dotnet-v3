...
namespace Microsoft.Azure.Cosmos
{
    ...
    internal static class AuthorizationHelper
    {
        ...
        public static bool CheckPayloadUsingKey(string inputToken,
            ...
            INameValueCollection headers,
            string key,
            out string payloadUsedForSignature)
        {
            string requestBasedToken = AuthorizationHelper.GenerateKeyAuthorizationSignatureWithoutEncode(
                verb,
                resourceId,
                resourceType,
                headers,
                key,
                out payloadUsedForSignature);
        ...
        // This is a helper for both system and master keys
        [SuppressMessage("Microsoft.Globalization", "CA1308:NormalizeStringsToUppercase", Justification = "HTTP Headers are ASCII")]
        private static string GenerateKeyAuthorizationSignatureWithoutEncode(string verb,
            string resourceId,
            string resourceType,
            INameValueCollection headers,
            string key,
            ...
            bool bUseUtcNowForMissingXDate = false)
        {
            ...
            using (HMACSHA256 hmacSha256 = new HMACSHA256(keyBytes))
            {
                ...
                return string.Format(CultureInfo.InvariantCulture, Constants.Properties.AuthorizationFormat,
                            Constants.Properties.MasterToken,
                            Constants.Properties.TokenVersion,
                            authorizationToken);
            }
