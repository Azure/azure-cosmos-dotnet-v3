//-----------------------------------------------------------------------
// <copyright file="DistinctItemQueryExecutionComponent.cs" company="Microsoft Corporation">
...
namespace Microsoft.Azure.Cosmos.Query.ExecutionComponent
{
    ...
    /// </summary>
    internal sealed class DistinctItemQueryExecutionComponent : ItemQueryExecutionComponentBase
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the DistinctItemQueryExecutionComponent class.
        /// </summary>
        ...
        private DistinctItemQueryExecutionComponent(
        ...
        /// <summary>
        /// Creates an DistinctItemQueryExecutionComponent
        /// </summary>
        ...
        public static async Task<ItemQueryExecutionComponentBase> CreateAsync(
            ...
            DistinctQueryType distinctQueryType)
        {
            ...
            return new DistinctItemQueryExecutionComponent(
                distinctQueryType,
