//-----------------------------------------------------------------------
// <copyright file="AggregateItemQueryExecutionComponent.cs" company="Microsoft Corporation">
...
namespace Microsoft.Azure.Cosmos.Query.ExecutionComponent
{
    ...
    /// </summary>
    internal sealed class AggregateItemQueryExecutionComponent : ItemQueryExecutionComponentBase
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the AggregateItemQueryExecutionComponent class.
        /// </summary>
        ...
        private AggregateItemQueryExecutionComponent(CosmosQueryExecutionComponent source, AggregateOperator[] aggregateOperators)
            : base(source)
        {
        ...
        /// <summary>
        /// Creates a AggregateItemQueryExecutionComponent.
        /// </summary>
        /// <param name="aggregateOperators">The aggregate operators for this query.</param>
        ...
        /// <returns>The AggregateItemQueryExecutionComponent.</returns>
        public static async Task<AggregateItemQueryExecutionComponent> CreateAsync(
            AggregateOperator[] aggregateOperators,
            string requestContinuation,
            Func<string, Task<CosmosQueryExecutionComponent>> createSourceCallback)
        {
            return new AggregateItemQueryExecutionComponent(await createSourceCallback(requestContinuation), aggregateOperators);
        }
