...
namespace Microsoft.Azure.Cosmos.Query.Core
{
    ...
    internal sealed class QueryMetrics
    {
        ...
        /// <summary>
        /// Add two specified <see cref="Microsoft.Azure.Cosmos.Query.Core.QueryMetrics"/> instances
        /// </summary>
        /// <param name="queryMetrics1">The first <see cref="Microsoft.Azure.Cosmos.Query.Core.QueryMetrics"/> instance</param>
        /// <param name="queryMetrics2">The second <see cref="Microsoft.Azure.Cosmos.Query.Core.QueryMetrics"/> instance</param>
        /// <returns>A new <see cref="Microsoft.Azure.Cosmos.Query.Core.QueryMetrics"/> instance that is the sum of two <see cref="Microsoft.Azure.Cosmos.Query.Core.QueryMetrics"/> instances</returns>
        ...
        /// <summary>
        /// Gets the stringified <see cref="Microsoft.Azure.Cosmos.Query.Core.QueryMetrics"/> instance in the Azure DocumentDB database service.
        /// </summary>
        /// <returns>The stringified <see cref="Microsoft.Azure.Cosmos.Query.Core.QueryMetrics"/> instance in the Azure DocumentDB database service.</returns>
        ...
        /// <summary>
        /// Gets the delimited stringified <see cref="Microsoft.Azure.Cosmos.Query.Core.QueryMetrics"/> instance in the Azure DocumentDB database service as if from a backend response.
        /// </summary>
        /// <returns>The delimited stringified <see cref="Microsoft.Azure.Cosmos.Query.Core.QueryMetrics"/> instance in the Azure DocumentDB database service as if from a backend response.</returns>
