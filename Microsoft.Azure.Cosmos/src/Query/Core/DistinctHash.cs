...
namespace Microsoft.Azure.Cosmos.Query
{
    ...
    {
        private static readonly UInt192 RootHashSeed = UInt192.Create(
            0xddef2a91418ae4ea,
            0x9fcd55808a038bf3,
            0x3e2614f44255738b);

        private static readonly UInt192 NullHashSeed = UInt192.Create(
            0xaa64e7e7095c45ed,
            0xbc660e452fdf5c95,
            0xaba2a6ee2816dc2a);

        private static readonly UInt192 FalseHashSeed = UInt192.Create(
            0x13d74df965a60011,
            0xa75872ce21865e72,
            0xd31fdca229b8cd24);

        private static readonly UInt192 TrueHashSeed = UInt192.Create(
            0x4272616e646f6e20,
            0x532043686f6e6700,
            0x5fe6eb50c7b537a9);

        private static readonly UInt192 NumberHashSeed = UInt192.Create(
            0xb682f02a12588b1d,
            0x0ed0c0611dd274e7,
            0x58f316f4543f1456);

        private static readonly UInt192 StringHashSeed = UInt192.Create(
            0x6807e00c508a5263,
            0x0961f2815ea02dd2,
            0xad47f5a77ee28667);

        private static readonly UInt192 ArrayHashSeed = UInt192.Create(
            0xe8dd264ef643c77b,
            0x6340f4f895f86fb3,
            0xe82c32939e1aa7c1);

        private static readonly UInt192 ObjectHashSeed = UInt192.Create(
            0x27ae100c664520b1,
            0xb3e8b5e578a281bf,
            0x6e53db80f59dbb3a);

        private static readonly UInt192 ArrayIndexHashSeed = UInt192.Create(
            0xf38a8aaa4c3089d1,
            0x5f693b1bd7fb6cee,
            0xc310c21dc865e342);

        private static readonly UInt192 PropertyNameHashSeed = UInt192.Create(
            0xff6be1e2b9304754,
            0xcd01ae19ec6204f5,
            0x47b889211c290322);
        /// <summary>
