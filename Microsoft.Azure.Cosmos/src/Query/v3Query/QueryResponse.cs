    ...
    class QueryResponse<T> : FeedResponse<T>
    {
            ...
            RequestMessage requestMessage)
        {
            ...
            this.IndexUtilizationText = ResponseMessage.DecodeIndexMetrics(
                ...
                isBase64Encoded: requestMessage != null ? requestMessage.Headers.CosmosMessageHeaders.Get(HttpConstants.HttpHeaders.PopulateIndexMetricsV2) != true.ToString() : false);
