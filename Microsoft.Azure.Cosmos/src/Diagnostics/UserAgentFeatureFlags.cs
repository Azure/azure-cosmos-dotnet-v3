...
namespace Microsoft.Azure.Cosmos
{
    ...
    /// This number will be converted in to a hex string following the prefix "F" to save space in the user agent as it is limited and appended to the user agent suffix.
    ...
    /// For example if the user agen sufix has F7, this means that the feature flags 1, 2 and 4 are enabled (the first three feature flags).
    /// </summary>
