...
namespace Microsoft.Azure.Cosmos
{
    ...
    public class RequestOptions
    {
        ...
        /// </value>
        /// <remarks>
        /// Most commonly used with the Delete* and Replace* methods of <see cref="CosmosItems"/> such as <see cref="CosmosItems.ReplaceItemAsync{T}(string, T, ItemRequestOptions, System.Threading.CancellationToken)"/>
