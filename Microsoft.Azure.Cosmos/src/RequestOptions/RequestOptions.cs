...
namespace Microsoft.Azure.Cosmos
{
    ...
    public class RequestOptions
    {
        ...
        /// </summary>
        /// <remarks>
        /// Most commonly used with the Delete* and Replace* methods of <see cref="CosmosContainer"/> such as <see cref="CosmosContainer.ReplaceItemAsync{T}(string, T, object, ItemRequestOptions, System.Threading.CancellationToken)"/>
