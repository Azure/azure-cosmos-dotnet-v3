...
namespace Microsoft.Azure.Cosmos.Fluent
{
    ...
    public class CosmosClientBuilder
    {
        ...
        /// <param name="limitToApplicationRegionOnly">When limiting to only the specified region, availability is reduced to that of a single region account, see https://docs.microsoft.com/azure/cosmos-db/high-availability. </param>
        /// <example>
        ...
        public CosmosClientBuilder WithApplicationRegion(
            ...
            bool limitToApplicationRegionOnly = false)
        {
            this.clientOptions.ApplicationRegion = applicationRegion;
            this.clientOptions.LimitToApplicationRegionOnly = limitToApplicationRegionOnly;
            return this;
        }
