...
namespace Microsoft.Azure.Cosmos.Telemetry
{
    ...
    internal static class TracesStabilityFactory
    {
        ...
        public static IActivityAttributePopulator GetAttributePopulator(CosmosClientMetricsOptions metricsOptions = null)
        {
            ...
            {
                OpenTelemetryStablityModes.Database or null => new OpenTelemetryAttributeKeys(metricsOptions),
                OpenTelemetryStablityModes.DatabaseDupe => new DatabaseDupAttributeKeys(metricsOptions),
                OpenTelemetryStablityModes.ClassicAppInsights => new AppInsightClassicAttributeKeys(metricsOptions),
                _ => new OpenTelemetryAttributeKeys(metricsOptions)
            };
        }
