...
namespace Microsoft.Azure.Cosmos.Telemetry
{
        ...
        sealed class DistributedTracingOptions
    {
        ...
        /// <summary>
        /// Since, Resolving request diagnostics is costly operation so, this setting will include the diagnostics only for the operations having more than the threshold latency,<br></br>
        /// So it is Latency Threshold to generate (<see cref="System.Diagnostics.Tracing.EventSource"/>) with Request diagnostics.<br></br>
