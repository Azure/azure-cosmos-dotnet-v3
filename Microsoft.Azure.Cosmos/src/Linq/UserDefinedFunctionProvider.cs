...
namespace Microsoft.Azure.Cosmos.Linq
{
    ...
    internal static class UserDefinedFunctionProvider
    {
        ...
        /// Refer to https://docs.microsoft.com/en-us/azure/cosmos-db/sql-query-linq-to-sql for more details about the LINQ provider.
        /// Refer to https://docs.microsoft.com/en-us/azure/cosmos-db/stored-procedures-triggers-udfs for more details about user defined functions.
        /// </remarks>
        /// <example> 
        /// <code language="c#">
        /// <![CDATA[
