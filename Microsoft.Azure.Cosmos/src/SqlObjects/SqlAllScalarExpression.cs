...
#pragma warning disable SA1600 // Elements should be documented
    ...
    internal
#endif
    sealed class SqlAllScalarExpression : SqlScalarExpression
    {
        ...
        public static SqlAllScalarExpression Create(SqlQuery subquery) => new SqlAllScalarExpression(subquery);
