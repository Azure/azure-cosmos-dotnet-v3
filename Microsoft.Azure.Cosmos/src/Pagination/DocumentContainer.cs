...
namespace Microsoft.Azure.Cosmos.Pagination
{
    ...
    internal sealed class DocumentContainer : IDocumentContainer
    {
        ...
        {
            return this.monadicDocumentContainer.MonadicGetChildRangeAsync(
partitionKeyRange,
cancellationToken);
        }
        ...
        public Task<List<PartitionKeyRange>> GetChildRangeAsync(
            ...
            CancellationToken cancellationToken)
        {
            return TryCatch<List<PartitionKeyRange>>.UnsafeGetResultAsync(
...
cancellationToken);
        ...
        public Task<TryCatch<List<PartitionKeyRange>>> MonadicGetFeedRangesAsync(
            CancellationToken cancellationToken)
        {
            return this.monadicDocumentContainer.MonadicGetFeedRangesAsync(
cancellationToken);
        }
...
cancellationToken);
        ...
        public Task<TryCatch<Record>> MonadicCreateItemAsync(
            ...
            CancellationToken cancellationToken)
        {
            return this.monadicDocumentContainer.MonadicCreateItemAsync(
payload,
cancellationToken);
        }
...
cancellationToken);
        ...
        public Task<TryCatch<Record>> MonadicReadItemAsync(
            ...
            CancellationToken cancellationToken)
        {
            return this.monadicDocumentContainer.MonadicReadItemAsync(
partitionKey,
identifer,
cancellationToken);
        }
        ...
        public Task<Record> ReadItemAsync(
            ...
            CancellationToken cancellationToken)
        {
            return TryCatch<Record>.UnsafeGetResultAsync(
...
cancellationToken);
        ...
        public Task<TryCatch<DocumentContainerPage>> MonadicReadFeedAsync(
            ...
            CancellationToken cancellationToken)
        {
            return this.monadicDocumentContainer.MonadicReadFeedAsync(
partitionKeyRangeId,
resourceIdentifer,
pageSize,
cancellationToken);
        ...
        public Task<DocumentContainerPage> ReadFeedAsync(
            ...
            CancellationToken cancellationToken)
        {
            return TryCatch<DocumentContainerPage>.UnsafeGetResultAsync(
...
cancellationToken);
        ...
        public Task<TryCatch> MonadicSplitAsync(
            ...
            CancellationToken cancellationToken)
        {
            return this.monadicDocumentContainer.MonadicSplitAsync(
partitionKeyRangeId,
cancellationToken);
        }
        ...
        public Task SplitAsync(
            ...
            CancellationToken cancellationToken)
        {
            return TryCatch.UnsafeWaitAsync(
