...
namespace Microsoft.Azure.Cosmos
{
    ...
    internal class ThinClientStoreModel : IStoreModelExtension, IDisposable
    {
            ...
            INameValueCollection responseHeaders)
        {
            ...
            {
                string resourceId = request.IsNameBased ? responseHeaders[HttpConstants.HttpHeaders.OwnerId] : request.ResourceId;
            ...
            IGlobalEndpointManager globalEndpointManager)
        {
            ...
            {
                return; // apply session token in case of session consistency and the request is read only or read/write on multimaster
            }
