...
namespace Microsoft.Azure.Cosmos.ChangeFeed.FeedManagement
{
    ...
    internal abstract class RemainingWorkEstimator
    {
        ...
        public abstract Task<long> GetEstimatedRemainingWorkAsync(CancellationToken cancellation);
        ...
        public abstract Task<IReadOnlyList<RemainingLeaseTokenWork>> GetEstimatedRemainingWorkPerLeaseTokenAsync(CancellationToken cancellation);
    }
}
