...
namespace Microsoft.Azure.Cosmos.ChangeFeed.FeedManagement.Streams
{
    ...
    using ChangeFeedObserver = Microsoft.Azure.Cosmos.ChangeFeed.FeedProcessing.Streams.ChangeFeedObserver;

    internal sealed class PartitionSupervisorStreamCore : PartitionSupervisor
    {
        ...
        public PartitionSupervisorStreamCore(DocumentServiceLease lease, ChangeFeedObserver observer, FeedProcessor processor, LeaseRenewer renewer)
        {
            this.lease = lease;
