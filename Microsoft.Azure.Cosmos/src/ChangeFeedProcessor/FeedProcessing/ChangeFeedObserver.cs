...
namespace Microsoft.Azure.Cosmos.ChangeFeed.FeedProcessing
{
    ...
    internal abstract class ChangeFeedObserver<T>
    {
        ...
        /// <param name="cancellation">Token to signal that the parition processing is going to finish.</param>
        /// <returns>A Task to allow asynchronous execution.</returns>
        public abstract Task ProcessChangesAsync(ChangeFeedObserverContext context, IReadOnlyCollection<T> docs, CancellationToken cancellation);
    }
}