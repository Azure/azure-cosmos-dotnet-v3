...
namespace Microsoft.Azure.Cosmos.ChangeFeed.FeedProcessing
{
    ...
    internal sealed class ChangeFeedObserverContextCore<T> : ChangeFeedObserverContext
    {
        ...
        internal ChangeFeedObserverContextCore(string leaseToken, CosmosQueryResponse<T> feedResponse, PartitionCheckpointer checkpointer)
        {
            this.LeaseToken = leaseToken;
        ...
        public CosmosQueryResponse<T> FeedResponse { get; }
        ...
        {
            return this.checkpointer.CheckpointPartitionAsync(this.FeedResponse.ContinuationToken);
        }
    }
}