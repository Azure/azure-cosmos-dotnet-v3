...
namespace Microsoft.Azure.Cosmos.ChangeFeed
{
    ...
    using Microsoft.Azure.Cosmos.ChangeFeed.FeedManagement.Streams;
    ...
    internal sealed class ChangeFeedProcessorStream : ChangeFeedProcessor
    {
        ...
        public ChangeFeedProcessorStream(ChangeFeedObserverFactory observerFactory)
        {
        ...
        private async Task InitializeAsync()
        {
            ...
            this.documentServiceLeaseStoreManager = await ChangeFeedProcessorStream.InitializeLeaseStoreManagerAsync(this.documentServiceLeaseStoreManager, this.leaseContainer, this.monitoredContainerRid, this.instanceName).ConfigureAwait(false);
        ...
        internal PartitionManager BuildPartitionManager()
        {
            ...
            PartitionSupervisorStreamFactory partitionSuperviserFactory = new PartitionSupervisorStreamFactory(
                factory,
                this.documentServiceLeaseStoreManager.LeaseManager,
