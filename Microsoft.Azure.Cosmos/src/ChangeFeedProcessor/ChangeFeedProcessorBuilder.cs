...
namespace Microsoft.Azure.Cosmos
{
    ...
    public class ChangeFeedProcessorBuilder
    {
        ...
        internal virtual ChangeFeedProcessorBuilder WithStartFromBeginning()
        {
            ...
            {
                throw new NotImplementedException($"Using the 'WithStartFromBeginning' option with ChangeFeedProcessor is not supported with {ChangeFeedMode.AllVersionsAndDeletes} mode.");
            }
        ...
        public ChangeFeedProcessorBuilder WithStartTime(DateTime startTime)
        {
            if (this.changeFeedProcessorOptions.Mode == ChangeFeedMode.AllVersionsAndDeletes)
            {
                throw new NotImplementedException($"Using the 'WithStartTime' option with ChangeFeedProcessor is not supported with {ChangeFeedMode.AllVersionsAndDeletes} mode.");
            }
