...
namespace Microsoft.Azure.Documents
{
    ...
    enum ReadConsistencyStrategy
    {
        ...
        /// <summary>
        /// Quorum read with GLSN barrier routed to the single write (hub) region.
        /// Sets the hub-region processing header so the request is served from the write region.
        /// Only valid for single-master accounts (rejected on multi-master accounts).
        /// </summary>
