...
namespace Microsoft.Azure.Documents
{
    ...
    sealed class OfferContentV2 : JsonSerializable
    {
            ...
            int? partitionCount = null)
        {
            ...
            this.OfferAutopilotSettings = offerAutopilotSettings != null ? new AutopilotSettings(offerAutopilotSettings) : (source.OfferAutopilotSettings != null ? new AutopilotSettings(source.OfferAutopilotSettings) : null);
