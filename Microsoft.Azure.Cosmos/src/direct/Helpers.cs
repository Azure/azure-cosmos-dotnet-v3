            ...
            T defaultValue) where T : struct
        {
            ...
            switch (typeof(T))
            {
                case Type intType when intType == typeof(int):
                    ...
                    // Value is not valid.
                    throw new ArgumentException(message: $"Environment variable :{name} has an invalid integer value of: {environmentVariableValue}.");
                ...
                case Type boolType when boolType == typeof(bool):
                    ...
                    // Value is not valid.
                    throw new ArgumentException(message: $"Environment variable :{name} has an invalid boolean value of: {environmentVariableValue}.");
            }
