...
namespace Microsoft.Azure.Documents.Rntbd
{
    ...
    internal static class TransportSerialization
    {
            ...
            out int? bodySize)
        {
            ...
            TransportSerialization.FillTokenFromHeader(request, HttpConstants.HttpHeaders.ReadConsistencyStrategy, requestHeaders.ReadConsistencyStrategy, rntbdRequest.readConsistencyStrategy, rntbdRequest);
