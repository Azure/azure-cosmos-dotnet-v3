...
namespace Microsoft.Azure.Documents
{
    ...
    /// - (Restart) <see cref="enableTcpConnectionEndpointRediscovery"/>=True and <see cref="notificationConcurrency"/>=0 (Subscription only non notifications)
    /// - <see cref="enableTcpConnectionEndpointRediscovery"/>=True and <see cref="notificationConcurrency"/> > 0 
