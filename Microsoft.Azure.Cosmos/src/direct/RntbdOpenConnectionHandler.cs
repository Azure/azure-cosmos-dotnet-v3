...
namespace Microsoft.Azure.Cosmos.Rntbd
{
    ...
    internal sealed class RntbdOpenConnectionHandler : IOpenConnectionsHandler, IDisposable
    {
        ...
        {
            this.disposed = false;
            this.transportClient = transportClient ?? throw new ArgumentNullException($"Argument {nameof(transportClient)} can not be null");
        ...
        /// <inheritdoc/>
        public async Task TryOpenRntbdChannelsAsync(IReadOnlyList<TransportAddressUri> addresses)
        {
